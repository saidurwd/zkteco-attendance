...
@section('title', 'Add Hikvision Device')

@section('content_header')
    <x-adminlte-content-header
        title="Add Hikvision Device"
        :breadcrumbs="[
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add Hikvision Device</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form method="POST" action="{{ route('hikvision.devices.store') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('device_serial') is-invalid @enderror" id="device_serial" name="device_serial" value="{{ old('device_serial') }}">
                            @error('device_serial')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('device_model') is-invalid @enderror" id="device_model" name="device_model" value="{{ old('device_model') }}">
                            @error('device_model')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('password_encrypted') is-invalid @enderror" id="password_encrypted" name="password_encrypted" value="{{ old('password_encrypted') }}">
